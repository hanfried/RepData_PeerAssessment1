...
```{r pre_process_the_data_into_suitable_format,echo=TRUE}
...
```{r histogram_imputed_steps_by_day,echo=TRUE}
...
```{r plot_average_steps_by_interval_faceted_by_weekpart,echo=TRUE}
...
```{r plot_average_steps_by_interval_and_part_of_week_overlapped_and_smoothed,echo=TRUE}
